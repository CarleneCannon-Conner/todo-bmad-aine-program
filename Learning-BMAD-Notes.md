...
- I managed to get back into the correct part of the UX flow to work on layout. Asking for emotional responses is interesting. This works well if you are in fact the designer or asking on behalf of the client. However, it can contradict the original PRD, so interesting decisions can end up being made.
